...
#### ⚠️ Version Conflict Warning: 
Do not use Optim v1.12.0 or higher. Version 1.12.0 removed the g_reltol parameter, which IonSim strictly requires. Using v1.12.0 will cause compilation and runtime failures. You must downgrade and pin Optim to v1.11.0 to maintain a stable environment.
